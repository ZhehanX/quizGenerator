...
**Pregunta 1:** Los únicos derechos que podrían tener exclusividad o ser remunerados son los derechos económicos.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 2:** La exclusividad de los derechos morales podría negociarse.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. Los derechos morales no pueden transferirse, por lo que la "exclusividad" no aplica.

**Pregunta 3:** Una diferencia entre XACML y MPEG-21 REL es que solo en el segundo caso es posible utilizar concesiones (grants) o licencias.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 4:** Un sistema de Gestión de Derechos Digitales (DRM) permite controlar los derechos morales sobre una obra ("creación").
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. Los derechos morales son inalienables. Un sistema DRM controla los derechos de explotación.

**Pregunta 5:** Los derechos económicos de una obra incluyen, entre otros: reproducción, distribución y comunicación pública.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 6:** Los derechos morales de una obra son irrevocables ("irrenunciables").
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 7:** Está permitido vender los derechos económicos de una obra.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 8:** Está permitido vender los derechos económicos de una obra, pero no los derechos morales.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 9:** Los derechos económicos podrían tener exclusividad o ser remunerados.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 10:** Existen algunas partes del estándar MPEG-21 que tratan sobre la representación de licencias para la gestión de derechos.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 11:** Una licencia, o concesión (grant), en un Lenguaje de Expresión de Derechos (REL) identifica un recurso al que se le asignan derechos con XACML.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. XACML es independiente de un REL.

**Pregunta 12:** Una concesión (o licencia, en general) en un lenguaje de expresión de derechos está destinada a identificar un recurso, qué operaciones están permitidas en él (y bajo qué condiciones), pero no identifica para quién es la licencia, lo cual se hace fuera.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. Además del recurso y las operaciones, también especifica para quién es la licencia.

**Pregunta 13:** Una concesión (o licencia, en general) en un lenguaje de expresión de derechos está destinada a identificar un recurso, qué operaciones están permitidas en él (y bajo qué condiciones), y para quién es la licencia.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 14:** Una concesión (o licencia, en general) en un lenguaje de expresión de derechos está destinada a identificar un recurso, qué operaciones están permitidas en él (y bajo qué condiciones), pero nunca identifica para quién es la licencia.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. También especifica para quién es la licencia.

**Pregunta 15:** Una concesión (o licencia, en general) en un lenguaje de expresión de derechos está destinada a identificar un recurso, qué operaciones están permitidas en él y para quién es la licencia. Sin embargo, las condiciones para las operaciones se expresan fuera.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. También especifica las condiciones.

**Pregunta 16:** Una concesión (grant) (en el contexto del Lenguaje de Expresión de Derechos de MPEG-21) identifica un recurso, qué operaciones están permitidas en él (y bajo qué condiciones), y para quién es la concesión.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 17:** El EME (Encrypted Media Extensions) del W3C especifica un canal de comunicación entre los navegadores web y el software del agente de DRM (Gestión de Derechos Digitales).
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Verdadero.

**Pregunta 18:** El propósito principal del EME (Encrypted Media Extensions) del W3C es definir cómo gestionar las claves en los navegadores web.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. EME define principalmente cómo gestionar el DRM en un entorno web.

**Pregunta 19:** El EME (Encrypted Media Extensions) del W3C limita los algoritmos de cifrado a utilizar. Solo permite unos pocos (menos de 10) de una lista en el estándar. Sin embargo, la lista podría ampliarse.
- [ ] Verdadero
- [ ] Falso
> **Respuesta:** Falso. EME proporciona un mecanismo para utilizar cualquier algoritmo de cifrado (implementado fuera del navegador).
